	...
	<div class="page-content">
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Listado</span> - Tutorias</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="extra_pnotify.php" class="breadcrumb-item">Listado</a>
			...
			<div class="content">
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
								...
								<div class="btn-group">
			                    	<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left dropdown-toggle" data-toggle="dropdown"><b><i class="icon-reading"></i></b> Agregar una tutoria</button>
			                    	<div class="dropdown-menu dropdown-menu-right">
										<a href="extra_jgrowl_noty.php" class="dropdown-item"><i class="icon-menu7"></i> Agregar Tutoria</a>
										<a href="extra_sweetalert.php" class="dropdown-item"><i class="icon-screen-full"></i> Editar tutorias</a>
						...
						<table class="table">
							...
							<tbody>
								<tr>
									...
									<td><a href="#" class="list-icons-paper" data-toggle="modal" data-target="#Actualizacion_modal">
					                <i class="icon-paragraph-justify3"></i>
									<td><a href="#" class="list-icons-item" data-toggle="modal" data-target="#remove_modal">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								Estas seguro de remover lo solicitado?
							</div>

							<div class="modal-footer">
								<button type="button" class="btn btn-primary" data-dismiss="modal">Si, Remuevelo</button>
				...
				<!-- Remove modal -->
				<div id="Actualizacion_modal" class="modal fade" role="dialog">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Confirma la acción</h5>
							...
							<div class="modal-body">
								Estas seguro de actualizar?
							</div>

							<div class="modal-footer">
								<button type="button" class="btn btn-primary" data-dismiss="modal">Si, Actualiza</button>
								<button type="button" class="btn btn-light" data-dismiss="modal">No, Gracias</button>
							</div>
						</div>
					</div>
