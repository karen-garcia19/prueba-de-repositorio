			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Listado</span> - Alumnos</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="content_cards.php" class="breadcrumb-item">Listado</a>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
								...
								<div class="btn-group">
			                    	<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left dropdown-toggle" data-toggle="dropdown"><b><i class="icon-reading"></i></b> Agregar nuevo alumno</button>
			                    	<div class="dropdown-menu dropdown-menu-right">
										<a href="content_cards_content.php" class="dropdown-item"><i class="icon-menu7"></i> Agregar Alumno</a>
										<a href="content_cards_layouts.php" class="dropdown-item"><i class="icon-screen-full"></i> Editar Alumno</a>
