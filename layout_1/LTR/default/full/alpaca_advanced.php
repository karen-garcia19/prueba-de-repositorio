			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Agregar</span> - Formulario de  departamentos</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="alpaca_advanced.php" class="breadcrumb-item">Agregar</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Agregar datos de departamentos correspondientes (Formulario)</h5>
						...
						<form action="#">
							<fieldset class="mb-3">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Código del empleado</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Categoría</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Que función tiene</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Código de encargado</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Zona en la que se ubica</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" autocomplete="off">
									</div>
								</div>
