			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Editar</span> - Departamento</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="alpaca_controls.php" class="breadcrumb-item">Editar</a>
					...
					<table class="table datatable-basic">
						<thead>
							<tr>
								...
								<th>Categoria</th>
								<th>Que función desempeña</th>
								<th>Codigo de encargado</th>
						...
						<tbody>
							...
							<tr>
								...
								<td>32541</td>
								<td>Licenciatura</td>
								<td>Leyes del departamento<a href="#"></a></td>
								<td>000546</td>
								<td>Zona norte</td>
								<td class="text-center">
									<div class="list-icons">
							...
							<tr>
								...
								<td>54213</td>
								<td>Tecnico en sistemas computacionales<a href="#"></a></td>
							...
							<tr>
								...
								<td>52134</td>
								<td>Comercio internacional<a href="#"></a></td>
							...
							<tr>
								...
								<td>65492</td>
								<td>Lectora de departamentos<a href="#"></a></td>
								<td>Librista</td>
								<td>265874</td>
								<td>Zona centro</td>
								<td class="text-center">
								...
								<table class="table">
									<thead>
										<tr>
									        ...
									        <td>Categoria</td>
									        <td>Que función desempeña</td>
									        <td>Codigo de encargado</td>
									        <td>Zona en la que se ubica</td>
