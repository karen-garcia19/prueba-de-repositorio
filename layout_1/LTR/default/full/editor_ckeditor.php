					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Text editors">
								...
								<li class="nav-item"><a href="editor_ckeditor.php" class="nav-link active">Agregar</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Agregar</span> - Formulario de empresas</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="editor_ckeditor.php" class="breadcrumb-item">Agregar</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Agregar datos de empresas correspondientes (Formulario)</h5>
					...
					<div class="card-body">
						...
						<form action="#">
							<fieldset class="mb-3">
								<legend class="text-uppercase font-size-sm font-weight-bold">Agregar información (formulario)</legend>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Razon social</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre del contacto</label>
									<div class="col-lg-10">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Puesto que ocupa</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" autocomplete="off">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Telefono ó celular</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" autocomplete="off">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Gmail</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" autocomplete="off">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Título (Sra/Sr/Lic/Ing/Dr)</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" autocomplete="off">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Ciudad de procedencia</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" autocomplete="off">
									</div>
								</div>
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2">Nombre de secretaria ó asistente</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" placeholder="" autocomplete="off">
									</div>
								</div>
