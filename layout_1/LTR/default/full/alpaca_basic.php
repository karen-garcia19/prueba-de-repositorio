					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="JSON forms">
								<li class="nav-item"><a href="alpaca_basic.php" class="nav-link active">Listado</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Listado - Departamentos</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="alpaca_basic.php" class="breadcrumb-item">Listado</a>
			...
			<div class="content">
				...
				<!--<div class="row">
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
								<h6 class="m-0 font-weight-semibold"></h6>
								<p class="text-muted mb-3"></p>

								<div class="btn-group">
			                    	<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left dropdown-toggle" data-toggle="dropdown"><b><i class="icon-reading"></i></b> Agregar nuevo departamento</button>
			                    	<div class="dropdown-menu dropdown-menu-right">
										<a href="alpaca_advanced.php" class="dropdown-item"><i class="icon-menu7"></i> Agregar departamento</a>
										<a href="alpaca_controls.php" class="dropdown-item"><i class="icon-screen-full"></i> Editar departamento</a>
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Listado de departamento</h5>
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th>Categoría</th>
									<th>Que función tiene</th>
									<th>Código de encargado</th>
									<th>Zona en la que se ubica</th>
								</tr>
							</thead>
							<tbody>
								<tr>
								...
								<tr>
									...
									<td>12543</td>
									<td>Recepcionista</td>
									<td>Recepcionista de entrada B</td>
									<td>000123</td>
									<td>Zona sur</td>
								</tr>
								<tr>
									...
									<td>13254</td>
									<td>Limpieza</td>
									<td>Limpieza de los departamentos</td>
									<td>000231</td>
									<td>Zona sur</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>Comerciante de canales t.v</td>
									<td>021548</td>
									<td>Zona centro</td>
								</tr>
								<tr>
								...
								<tr>
									<td>10</td>
									<td>65492</td>
									<td>Lectora de departamentos</td>
									<td>Librista</td>
									<td>265874</td>
									<td>Zona centro</td>
								</tr>
								...
								<tr>
									<td>14</td>
									<td>89654</td>
									<td>Supervición de areas especiales</td>
				...
				<div class="mb-3">
					...
					<span class="text-muted d-block">Listado</span>
				</div>/-->
				<!-- /text inputs title -->
