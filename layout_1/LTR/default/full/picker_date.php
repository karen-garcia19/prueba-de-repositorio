					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Text editors">
								...
								<li class="nav-item"><a href="editor_trumbowyg.php" class="nav-link">Editor</a></li>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="picker_date.php" class="breadcrumb-item">Listado</a>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
								...
								<div class="btn-group">
			                    	<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left dropdown-toggle" data-toggle="dropdown"><b><i class="icon-reading"></i></b> Agregar vacaciones</button>
			                    	<div class="dropdown-menu dropdown-menu-right">
										<a href="picker_color.php" class="dropdown-item"><i class="icon-menu7"></i> Agregar vacaciones</a>
										<a href="picker_location.php" class="dropdown-item"><i class="icon-screen-full"></i> Editar vacaciones</a>
						...
						<table class="table">
							<thead>
								<tr>
									...
									<th>Dias de vacaciones por derecho (1 año = 6 dias)</th>
