					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="JSON forms">
								<li class="nav-item"><a href="alpaca_basic.php" class="nav-link">Listados</a></li>
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Text editors">
								<li class="nav-item"><a href="editor_summernote.php" class="nav-link active">Listado</a></li>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="editor_summernote.php" class="breadcrumb-item">Listado</a>
					...
					<div class="col-lg-4">
						<div class="card card-body border-top-primary">
							<div class="text-center">
								...
								<div class="btn-group">
			                    	<button type="button" class="btn bg-teal-400 btn-labeled btn-labeled-left dropdown-toggle" data-toggle="dropdown"><b><i class="icon-reading"></i></b> Agregar nueva empresa</button>
			                    	<div class="dropdown-menu dropdown-menu-right">
										<a href="editor_ckeditor.php" class="dropdown-item"><i class="icon-menu7"></i> Agregar empresa</a>
										<a href="editor_trumbowyg.php" class="dropdown-item"><i class="icon-screen-full"></i> Editar empresas</a>
