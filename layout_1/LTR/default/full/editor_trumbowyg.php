					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Text editors">
								...
								<li class="nav-item"><a href="editor_trumbowyg.php" class="nav-link active">Editar</a></li>
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Editar</span> - Empresas</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="editor_trumbowyg.php" class="breadcrumb-item">Editar</a>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">Editar empresas</h5>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							<div class="modal-header bg-transparent">
								<h5 class="modal-title">Editar empresas</h5>
								...
								<table class="table">
									<thead>
										<tr>
									        ...
									        <td>Puesto que ocupa</td>
									        <td>Telefono ó celular</td>
									        <td>Gmail</td>
									        <td>Título</td>
									        <td>Ciudad de procedencia</td>
									        <td>Nombre de secretaria o asistente</td>
